...
#shield small
execute if score addie_shield_unlocked addie_tardis_upgrades matches 0 if score addie_tardis_shields addie_tardis_functions matches 1 at @e[tag=tardis] if entity @e[type=!minecraft:player,type=!minecraft:wolf,type=!cat,distance=..3.5] run effect give @e[type=!minecraft:player,type=!minecraft:wolf,type=!cat,distance=..3.5] minecraft:slowness 255 10

execute at @p run summon armor_stand ~ ~ ~ {NoGravity:1b,Invulnerable:1b,Invisible:1b,Tags:[tardis],ShowArms:1,Pose:{RightArm:[0f,0f,0f]},ArmorItems:[{},{},{},{id:"minecraft:cyan_dye",count:1,components:{"minecraft:custom_model_data":1}}]}

...
execute if score addie_tardis_doors_open addie_tardis_door matches 1 at @e[tag=door] run playsound minecraft:police_box_open ambient @a[distance=..5] ~ ~ ~ 2 1 1
execute if score addie_tardis_doors_open addie_tardis_door matches 2 at @e[tag=door] run playsound minecraft:police_box_open ambient @a[distance=..5] ~ ~ ~ 2 1 1

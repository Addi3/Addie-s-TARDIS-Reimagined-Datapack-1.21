execute if score addie_tardis_power addie_tardis_functions matches 0 if score addie_tardis_landed addie_tardis_functions matches 1 run function addie:tardis/functions/de_remat/error_power

...
execute if score addie_demat_animate addie_tardis_animations matches 109 run function addie:tardis/phases/phase_3
...
execute if score addie_demat_animate addie_tardis_animations matches 125 run function addie:tardis/phases/phase_7
